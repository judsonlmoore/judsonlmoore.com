...
Find [the documentation here]({{ site.url }}/docs/_includes/popper-documentation.md).
...
Find [the documentation here]({{ site.url }}/docs/_includes/tooltip-documentation.md).
...
frameworks, visit the [MENTIONS]({{ site.url }}/MENTIONS.md) page.
...
Visit the [MENTIONS]({{ site.url }}/MENTIONS.md) page for an updated list of projects.
