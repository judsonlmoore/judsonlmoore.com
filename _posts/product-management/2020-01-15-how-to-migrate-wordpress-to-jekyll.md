...
If **option 1** from the last step worked for you, then you can probably skip this step. Otherwise, you must still convert your Wordpress export file into the Jekyll folder structure and file formats. 
...
If you decide to try out Github pages, I encourage you to check out [this step-by-step guide by Jonathan McGlone](http://jmcglone.com/guides/github-pages/) for a tutorial on how to get that up and running.
...
I am using [this layout by Anatol Broder](http://jch.penibelst.de/) to compress all of my HTML files. It is straightforward to set up and avoids the use of plugins, which is preferable.
