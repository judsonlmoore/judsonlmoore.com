...
tags:
  ...
  - road trip
  - travel tale
description:					The annual trivago on Tour trip went on a Nordic cruise in 2017. Learn about the surprise concerts, unknown destinations, and jumping with moose.
...
**Read more: [How metasearch saves me loads of time and money](/what-is-metasearch/)**
...
[My first *trivago on Tour*](https://whereisper.com/blog/trivago-on-tour-ibiza) was in 2016 when trivago chartered a fleet of jets to fly us to the Mediterranean island of Ibiza. Now in 2017, our destination turned out to be **a Nordic cruise to Norway and Denmark**.
...
There are many examples of this kind of non-elitism demonstrated by trivago leadership. Still, I felt that the founder might opt-in to a little better sleep in this incredibly uncomfortable, long, middle of the night train ride. **So good on you, Rolf. Good on you.**

{% cloudinary post-image /assets/images/2017/10/trivago-on-tour-2017-train.jpg alt="The *trivago on Tour* 2017 train" %}
...
{% cloudinary post-image /assets/images/2017/10/trivago-on-tour-2017-cruise-ship.jpg alt="*trivago on Tour* is on a cruise ship" %}
...
{% include youtube.html src="https://www.youtube.com/embed/b_6quek7QzY" %}
...
**Further reading: [How to spend a day in Denmark: A bike tour of Copenhagen](/bike-tour-copenhagen/)**

{% cloudinary post-image /assets/images/2017/10/trivago-on-tour-2017-copenhagen-bike-ride.jpg alt="*trivago on Tour* takes a bike ride through Copenhagen, Denmark" %}
